    ...
    const translateInteractionKnob = () => {
        if (movementRef.current === "left" && document.getElementById("INTERACTION-AREA-LEFT") !== null) {
            ...
            if (window.innerWidth - window.innerWidth * 0.05 - document.getElementById("KNOB-AREA-INTERACTION").getBoundingClientRect().right <= 0) {
                setTranslateKnobTo(0);
                setMovement("none");
            } else if (window.innerWidth - window.innerWidth * 0.0504 - document.getElementById("KNOB-AREA-INTERACTION").getBoundingClientRect().right < 5) {
                setTranslateKnobTo(window.innerWidth - window.innerWidth * 0.0504 - document.getElementById("KNOB-AREA-INTERACTION").getBoundingClientRect().right);
            } else {
                setTranslateKnobTo(5);
            }
